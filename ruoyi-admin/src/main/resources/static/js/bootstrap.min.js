...
if (typeof jQuery === "undefined") {
    ...
    function(c) {
        ...
        function b(f) {
            return this.each(function() {
                ...
                var g = c.extend({},
                    d.DEFAULTS, j.data(), typeof f == "object" && f);
    ...
    function(h) {
        ...
        h(document).on("click.bs.dropdown.data-api", d).on("click.bs.dropdown.data-api", ".dropdown form",
            function(i) {
                i.stopPropagation()
    ...
    function(d) {
        ...
        b.prototype.show = function(h) {
            ...
            this.$dialog.on("mousedown.dismiss.bs.modal",
                function() {
                    f.$element.one("mouseup.dismiss.bs.modal",
                        function(i) {
            ...
            this.backdrop(function() {
                ...
                j ? f.$dialog.one("bsTransitionEnd",
                    function() {
    ...
    function(d) {
        ...
        c.prototype.init = function(l, j, g) {
            ...
            if (l === "popover" && this.options.trigger === "hover") {
                this.options.template = '<div class="popover" role="tooltip"><h3 class="popover-title"></h3><div class="popover-content"></div></div>'
            }
        ...
        c.prototype.getDelegateOptions = function() {
            ...
            this._options && d.each(this._options,
                function(g, h) {
                    if (f[g] != h) {
                        e[g] = h
                    }
        ...
        c.prototype.enter = function(f) {
            ...
            if ((e.tip().hasClass("in") || e.hoverState == "in") && !(e.type === "popover" && e.inState.hover)) {
                e.hoverState = "in";
                return
            }
            ...
            if (!e.options.delay || !e.options.delay.show) {
                if (e.type === "popover" && e.inState.hover) {
                    d('[role="tooltip"]').each(function() {
                        d(this).removeClass("in");
                        d(this).remove()
                    })
                }
                e.show();
                if (e.type === "popover" && e.inState.hover) {
                    d(e.$tip).on("mouseleave", this.options.selector, d.proxy(this.leave, this))
                }
                return
            }
        ...
        c.prototype.show = function() {
            ...
            if (this.hasContent() && this.enabled) {
                ...
                if (this.type === "popover" && this.options.trigger === "hover") {
                    if (i.left) {
                        i.left += 15
                    }
                }
